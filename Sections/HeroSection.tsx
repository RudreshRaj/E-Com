...
const HeroSection = (props: Props) => {
  return (
    <div className="container bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-20 text-center lg:pt-20">
          ...
          <span className="inline-block">
            ...
            <span className="relative whitespace-nowrap text-primary">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.58em] w-full fill-slate-900/70"
        ...
        <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          <span className="inline-block">You Choose,&nbsp;</span>
          <span className="inline-block">We bring it home.</span>
        </p>
      </div>
    </div>
  );
